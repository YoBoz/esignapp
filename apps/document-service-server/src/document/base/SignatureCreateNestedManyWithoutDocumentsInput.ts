...
@InputType()
class SignatureCreateNestedManyWithoutDocumentsInput {
...
export { SignatureCreateNestedManyWithoutDocumentsInput as SignatureCreateNestedManyWithoutDocumentsInput };
